 ...
 */
/*
function network_db_upgrade_1() {
}
function network_db_upgrade_2() {
}
*/

function icms_module_update_network($module) {
    return TRUE;
}

function icms_module_install_network($module) {
	return TRUE;
}